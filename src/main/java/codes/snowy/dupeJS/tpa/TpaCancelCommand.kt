...
@CommandAlias("tpacancel|tpcancel")
class TpaCancelCommand: BaseCommand() {

    private val tpaManager = TpaManager()

    @Default
    @CommandCompletion("@players")
    fun onTpaCancelCommand(acceptee: CommandSender, senderName: String) {
        ...
        tpaManager.cancelTeleport(acceptee, sender)
    }
}